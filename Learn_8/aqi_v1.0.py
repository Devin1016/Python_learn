...
def cal_co_iaqi(co_val):
    if 0 <= co_val < 3:
        ...
        iaqi = cal_linear(50, 100, 35, 4, co_val)
    elif 5 <= co_val < 15:
        iaqi = cal_linear(100, 150, 75, 14, co_val)
    elif 15 <= co_val < 25:
        iaqi = cal_linear(150, 200, 115, 24, co_val)
    elif 25 <= co_val < 37:
        iaqi = cal_linear(200, 300, 150, 36, co_val)
    elif 37 <= co_val < 49:
        iaqi = cal_linear(300, 400, 250, 48, co_val)
    elif 49 <= co_val < 61:
        iaqi = cal_linear(400, 500, 350, 60, co_val)
    else:
        iaqi = 500
    return iaqi
